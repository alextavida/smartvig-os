...
// Tecnicos com OS em andamento (independente de terem GPS ou nao)
$comOs = $pdo->query(
    "SELECT DISTINCT
       u.id AS tecnico_id,
     ...
     FROM usuarios u
     INNER JOIN os_tecnicos ot ON ot.tecnico_id = u.id
     INNER JOIN ordens_servico os ON os.id = ot.os_id
                                  AND os.situacao_local = 'em_andamento'
